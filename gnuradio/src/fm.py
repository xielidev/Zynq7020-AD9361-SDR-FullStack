...
class fm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FM_radio", catch_exceptions=True)
        ...
        self._center_freq_range = qtgui.Range(88e6, 108e6, 100e3, 101.1e6, 200)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.iio_fmcomms2_source_0 = iio.fmcomms2_source_fc32('ip:192.168.90.7', [True, True, False, False], 32768)
        self.iio_fmcomms2_source_0.set_len_tag_key('packet_len')
        self.iio_fmcomms2_source_0.set_frequency(int(center_freq))
        ...
        self.connect((self.iio_fmcomms2_source_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 80e3, 15e3, window.WIN_HAMMING, 6.76))
    ...
    def set_center_freq(self, center_freq):
        ...
        self.iio_fmcomms2_source_0.set_frequency(int(self.center_freq))
        self.qtgui_freq_sink_x_0.set_frequency_range(self.center_freq, self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.center_freq, self.samp_rate)
