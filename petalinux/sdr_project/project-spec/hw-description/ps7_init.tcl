...
proc ps7_clock_init_data_3_0 {} {
    ...
    mask_write 0XF800012C 0x01FFCCCD 0x01DC4C4D
    mwr -force 0XF8000004 0x0000767B
}
...
proc ps7_mio_init_data_3_0 {} {
    ...
    mask_write 0XF8000830 0x003F003F 0x00090037
...
proc ps7_peripherals_init_data_3_0 {} {
    ...
    mask_write 0XE000A204 0xFFFFFFFF 0x00002000
    mask_write 0XE000A000 0xFFFFFFFF 0xDFFF2000
    mask_write 0XE000A208 0xFFFFFFFF 0x00002000
